      ...
      <div class="container" style="margin-top: 10px">
          <div class="row mt-3">
            <div class="col">
              <div class="text-center">
                      <h2>Assign an Intervention Session</h2>
              </div>
            </div>
          </div>
          <div class="row mt-3"></div>
            <div class="col-md-6 offset-md-3">
              <div class="text-center">
              <form id="form" action="<?php echo base_url() ?>index.php/InterventionSession/create_intervention_session" method="post">
				...
				$input.change(function() {
					...
					if (current) {
						if (current.name == $input.val()) {
							$.ajax({
								url: base_url+"index.php/UserManagement/get_patient_information",
								type: 'POST',
